...
const GoogleAuthButton = () => {
  ...
  return (
    <button
      ...
      className={`w-full px-4 md:px-6 py-3 md:py-3.5 rounded-xl md:rounded-2xl font-medium relative overflow-hidden
                 backdrop-blur-md bg-white/10 hover:bg-white/15 
                 border border-white/10 text-white transition-all duration-300 text-sm md:text-base
    ...
    >
      ...
      <div className="flex items-center justify-center relative z-10">
        {/* Google logo */}
        <div className="flex items-center justify-center w-4 h-4 md:w-5 md:h-5 bg-white rounded-full mr-2 shadow-sm">
          <svg width="12" height="12" className="md:w-3.5 md:h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
