...
const GoogleAuthButton = () => {
  ...
  return (
    <button
      ...
      className={`w-full px-3 md:px-4 py-2.5 md:py-3 rounded-lg md:rounded-xl font-medium relative overflow-hidden
                 backdrop-blur-md bg-white/10 hover:bg-white/15 
                 border border-white/10 text-white transition-all duration-300 text-xs md:text-sm
    ...
    >
      ...
      <div className="flex items-center justify-center relative z-10">
        {/* Google logo - smaller */}
        <div className="flex items-center justify-center w-3.5 h-3.5 md:w-4 md:h-4 bg-white rounded-full mr-2 shadow-sm">
          <svg width="10" height="10" className="md:w-3 md:h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
